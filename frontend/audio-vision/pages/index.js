...
const Home = () => {
  ...
  const { sendMessage } = useWebSocket(IP, {
  ...
  return (
    <Box width="100%" height="100vh" position="relative">
      ...
      <Container
        maxWidth="sm"
        sx={{ position: "relative", height: "calc(100% - 64px)" }}
      >
        <Box
          className="pointer"
          sx={{
          ...
          style={{
            transform: `translate(-50%, -50%) rotate(${ang}rad)`,
            background: `radial-gradient(circle, rgba(0, 0, 0, 0.555) 0%, rgba(0, 212, 255, 0) ${
              int * 20
            }%)`,
          }}
        >
          <Image src="/pointer_shadow.png" width="700px" height="700px" />
        </Box>
        <Box
          className="circle"
          sx={{ width: "500px", height: "500px", borderRadius: "50%" }}
        >
          {img ? (
            <img
